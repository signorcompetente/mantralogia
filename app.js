...
function FantacalcioSwitch() {
  ...
  className="px-5 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl font-bold text-2xl shadow-xl hover:scale-105 hover:shadow-2xl transition-all duration-200"
